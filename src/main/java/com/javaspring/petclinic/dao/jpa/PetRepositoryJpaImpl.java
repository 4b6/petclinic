package com.javaspring.petclinic.dao.jpa;

import com.javaspring.petclinic.dao.PetRepository;
import com.javaspring.petclinic.model.Pet;
...
public class PetRepositoryJpaImpl implements PetRepository {
    ...
    public List<Pet> findByOwnerId(Long ownerId) {
        return entityManager.createQuery("from Pet where owner.id=:owner_Id",Pet.class)
